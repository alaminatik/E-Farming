<div id="content_holder" class="fixed">
    <div class="inner">
        <div class="breadcrumb"> <a href="<?php echo base_url(); ?>welcome">Home</a> » <a href="<?php echo base_url();?>welcome/login_form">Login</a> </div>
        <h2 class="heading-title"><span>Login</span></h2>
...
<!--                                <a href="<?php echo base_url();?>checkout/forget_password">Forget Password</a>-->
                    ...
                    <div class="clear"></div>
                    <div class="buttons" >
                        <div class="left" ><input type="submit" value="Submit" class="button" id="button-contact" ></div>
                    </div>
                </div>
            </form>
        </div>
