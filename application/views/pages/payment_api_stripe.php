...
//require '../classes/welcome_model.php';
...
if (isset($order_id)) {
    ...
    $order_info = $result->fetch(PDO::FETCH_ASSOC);
    $user_id = $order_info['id'];
    $sql_user = "SELECT * FROM tbl_user WHERE Id='$id'";
    $user_result = $conn->query($sql_user);
    $user_info = $user_result->fetch(PDO::FETCH_ASSOC);
    if (isset($due_pay)) {
        $order_info['order_total'] = $due_pay;
    }
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_Udy1cfZr5Kv6MTXDdHHxyleI');
            ...
            <div class="row row-centered">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    if ($_POST) {
                        ...
                        try {
                            if (empty($_POST['city']) || empty($_POST['zip']))
                                throw new Exception("Fill out all required fields.");
                            if (!isset($_POST['stripeToken']))
                                throw new Exception("The Stripe Token was not generated correctly");
                            Stripe_Charge::create(array("amount" => ceil($order_info['order_total'] / 79.59) * 100,
                                "currency" => "eur",
                                "card" => $_POST['stripeToken'],
                                "description" => $_POST['email']));
                            $wl_mod->online_payment_stripe($order_id, $order_info['order_total'], "Successfull");
                            $_SESSION['online_confirmation'] = "Your Payment is Successfully Completed.";
			  ...
			  <strong>Error!</strong> ' . $e->getMessage() . '
                    ...
                    <span class="payment-success">
                        ...
                        <?= $error ?>
                        <?php
                        if (isset($_SESSION['online_confirmation'])) {
                            unset($_SESSION['online_confirmation']);
                            ?> 
                            <a class="btn btn-warning" href="../user_profile.php">Go Back</a>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="email_address" maxlength="65" placeholder="Email" class="email form-control">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="" maxlength="70" class="form-control" value="<?php echo $order_info['order_total']; ?>">
                            </div>
                        </div>
