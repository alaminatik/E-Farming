                ...
                <div class="col-sm-12">
                    <div class="form-row form-group">
                        <label>
                            ...
                            <input type="text" size="20" class="form-control" name="username" value="<?php echo $name; ?>" id="u_name" readonly>
                        </label>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-row form-group">
                        <label>
                            ...
                            <input type="text" size="20" class="form-control" value="<?php echo $gtotal; ?>" name="charge" id="crgVal" readonly>
                        </label>
                    </div>
                </div>
