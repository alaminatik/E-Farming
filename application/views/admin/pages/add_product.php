<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo site_url('super_admin/store_product'); ?>" method="post" enctype="multipart/form-data">
                <fieldset>
...
<!--                            <textarea class="cleditor" id="textarea2" rows="3" name="manufacturer_description"></textarea>-->
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" id="textarea2" rows="3" name="product_description"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Product Price</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="product_price"  name="product_price" data-provide="typeahead" data-items="4" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" class="span6 typeahead" id="product_stock"  name="product_stock" data-provide="typeahead" data-items="4" >
