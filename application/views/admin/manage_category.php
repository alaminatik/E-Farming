                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <?php }?>
                            <a class="btn btn-info" href="<?php echo base_url();?>super_admin/edit_category/<?php echo $category->category_id;?>" title="edit">
                                <i class="halflings-icon white edit"></i>  
                            </a>
                            <a class="btn btn-danger" href="<?php echo base_url();?>super_admin/delete_category/<?php echo $category->category_id;?>" onclick="return check_delete();" title="delete">
